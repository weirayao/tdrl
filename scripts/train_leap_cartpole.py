...
from LiLY.baselines.LEAP.srnn_cartpole import SRNNConv
from LiLY.tools.utils import load_yaml, setup_seed
from LiLY.datasets.cartpole import CartpoleDatasetTwoSample
...
def main(args):
    ...
    data = CartpoleDatasetTwoSample(directory=cfg['ROOT'], dataset='cartpole')
    ...
    model = SRNNConv(nc=cfg['VAE']['NC'],
                     ...
                     z_dim=cfg['VAE']['DYN_DIM'], 
                     z_dim_trans=cfg['VAE']['DYN_DIM'], 
                     lag=cfg['VAE']['LAG'],
